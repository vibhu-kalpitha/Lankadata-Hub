...
export const metroRoutesData: RouteMapItem[] = [
  ...
  },
  {
    ...
    pathD: 'M 65.5 472 L 66 476 L 65 475 L 66.5 480 L 66 483 L 68.5 486 L 70.5 488 L 72 490 L 62 490 L 64 500 L 67 512 L 70 525',
    distance: '28.7 km',
    duration: '1h 45m',
...
const metroStops: MetroStopNode[] = [
  ...
  { name: 'Panadura Terminal', cx: 70, cy: 525, routes: ['CM04'] },
  ...
  { name: 'Moratuwa', cx: 67, cy: 512, routes: ['CM04'] },
